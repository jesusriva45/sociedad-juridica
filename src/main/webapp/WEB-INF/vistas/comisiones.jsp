...
<body>
	<header>
		...
		<div class="padreNosotros">
			<div class="NavNosotros">Comisiones</div>
		</div>
	</header>
	<br>
	<br>
	...
	<br>
	<article class="postula">
		<div class="info">
			<h1 class="tit">¿Quieres formar parte de Sociedad Jurídica?</h1>
			<br>
			<p class="parr">
				Postula a Sociedad Jurídica y elije la que más se ajuste a tu
				perfil. <br> Haga Clic para postular
			</p>
			<br>
			<div>
				<a href="verPostula"><button type="button"
						class="btn btnPostula">Postular</button></a>
			</div>
		</div>
