...
<body>
    ...
    <div class="contimg">
        <img src="Imagenes/Ban2Revista.jpeg" alt="">
    </div>

    <h1 class="TitRevistas">
        Nuestras Revistas
    </h1>

    <section class="secRevista">
        <div id="tarjetas-revistas" class="revista">
    ...
    <script>
    	...
    	$.getJSON("listaRevistas", function (data){				
    		$.each(data, function(index,item){             
    			$('#tarjetas-revistas').append("<div class='cardRevista'>"+
    		                "<div>"+
