...
<body>
                ...
                <div class=" col-md-10">
                  <ul class="navbar-nav offset-md-2">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu navopciones" aria-labelledby="navbarDropdown">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu navopciones2" aria-labelledby="navbarDropdown"><!---->
    ...
    <section class="secOtros">
        <div class="otros">
            <div class="cardOtros">
                <div>
                    <h4 class="DerPenal">Derecho Penal</h4>
                    <img class="imgNew" src="Imagenes/843861.jpg_gde.jpg" alt="">
            ...
            <div class="cardOtros">
                <div>
                    <h4 class="DerPenal">Derecho Penal</h4>
                    <img class="imgNew" src="Imagenes/jakob-dalbjorn-730178-unsplash-min.jpg" alt="">
                    <a href="#" class="nuevoLink">Dos caras, una moneda: Curso Interdisciplinario de Derecho Civil y Penal.</a>
                    <p class="m-lg-1">20/12/20 - 19:00 hrs</p>
                </div>
            </div> <div class="cardOtros">
                <div>
                    <h4 class="DerPenal">Derecho Penal</h4>
                    <img class="imgNew" src="Imagenes/843861.jpg_gde.jpg" alt="">
                    <a href="#" class="nuevoLink">Dos caras, una moneda: Curso Interdisciplinario de Derecho Civil y Penal.</a>
