...
<head>
    ...
    <link rel="stylesheet" href="css/aExtraordinarios.css">
    ...
    <title>Asociados Extraordinarios</title>
</head>
<body>
    ...
    <section class="secConsejo">
      
        <div class="consejo">
            <div class="cardNuevo">
                <div>
                    <img class="imgSJ" src="Imagenes/abogadoReferencia.jpg" alt="">
                </div>
                <p class="nombre">
                    Nombre 
                  </p>
                  <p class="cargo">
                    Una breve introducción de su carrera del abogado... 
                  </p>
            </div> 
            <div class="cardNuevo">
                <div>
